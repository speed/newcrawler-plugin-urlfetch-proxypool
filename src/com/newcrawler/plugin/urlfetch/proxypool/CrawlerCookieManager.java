...
public class CrawlerCookieManager extends CookieHandler{

	private final static Log logger = LogFactory.getLog(CrawlerCookieManager.class);
	
	private CrawlerCookiePolicy policyCallback;
     ...
     *                          be used.
     */
    public CrawlerCookieManager(CookieStore store,
    		CrawlerCookiePolicy cookiePolicy)
    {
        // use default cookie policy if not specify one
        policyCallback = (cookiePolicy == null) ? CrawlerCookiePolicy.ACCEPT_ORIGINAL_SERVER
                                                : cookiePolicy;

        // if not specify CookieStore to use, use default one
        if (store == null) {
            throw new HtmlFetchException("CookieStore is required.");
        }
     ...
     */
    public void setCookiePolicy(CrawlerCookiePolicy cookiePolicy) {
